...
// Game-specific types
interface EmptyGamePlayer extends Player {
  // Add any custom player properties here
}

interface EmptyGameGamedatas extends Gamedatas<EmptyGamePlayer> {
  // Add any custom gamedata properties here
}

// State args interfaces
interface PlayerTurnArgs {
  playableCardsIds: number[];
  // Add other properties that this state receives from the server
}