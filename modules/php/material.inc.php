...
if (!defined('DECK_LENGTH_2_PLAYERS')) { // guard since this included multiple times
    ...
    define("SOLO_DIFFICULTY_FACEDOWN_PENALTY", 1); //solo: lose 1 point per face-down card remaining in your row
    define("SOLO_COMPARE_THRESHOLD", 20); //solo: revealed rank below this discards the lower-numbered center card, at/above discards the higher-numbered one
