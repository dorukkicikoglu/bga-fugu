...
--
-- Host: mysql
-- Generation Time: Jul 16, 2026 at 07:23 PM
...
(4, 'card', 0, 'center', 1, NULL, NULL, 'coral_green', 4),
(5, 'card', 0, 'player', 2367143, 'number', 1, 'pufferfish', 5),
(6, 'card', 0, 'player', 2367142, 'number', 2, 'bannerfish', 6),
(7, 'card', 0, 'player', 2367142, 'number', 3, 'coral_yellow', 7),
...
(11, 'card', 0, 'center', 2, NULL, NULL, 'pufferfish', 11),
...
(16, 'card', 0, 'center', 3, NULL, NULL, 'coral_yellow', 16),
(17, 'card', 0, 'player', 2367142, 'facedown', 18, 'pufferfish', 17),
(18, 'card', 0, 'player', 2367143, 'number', 5, 'bannerfish', 18),
(19, 'card', 0, 'player', 2367143, 'facedown', 16, 'coral_pink', 19),
(20, 'card', 0, 'player', 2367143, 'number', 6, 'octopus', 20),
...
(33, 'card', 0, 'player', 2367143, 'number', 11, 'bannerfish', 33),
(34, 'card', 0, 'player', 2367143, 'facedown', 17, 'coral_yellow', 34),
(35, 'card', 0, 'player', 2367142, 'anchor', 4, 'pufferfish', 35),
(36, 'card', 0, 'player', 2367142, 'number', 9, 'bannerfish', 36),
(37, 'card', 0, 'player', 2367142, 'number', 10, 'octopus', 37),
(38, 'card', 0, 'player', 2367143, 'anchor', 2, 'coral_pink', 38),
(39, 'card', 0, 'player', 2367143, 'number', 12, 'bannerfish', 39);
