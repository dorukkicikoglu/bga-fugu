...
--
-- Host: mysql
-- Generation Time: Jul 17, 2026 at 12:03 AM
...
(1, 'card', 0, 'player', 2367142, 'anchor', 14, 'coral_pink', 1),
(2, 'card', 0, 'center', 1, NULL, NULL, 'octopus', 2),
(3, 'card', 0, 'player', 2367143, 'number', 2, 'bannerfish', 3),
(4, 'card', 0, 'player', 2367142, 'number', 2, 'coral_green', 4),
...
(14, 'card', 0, 'player', 2367143, 'anchor', 18, 'octopus', 14),
...
(18, 'card', 0, 'player', 2367142, 'number', 8, 'bannerfish', 18),
(19, 'card', 0, 'player', 2367143, 'number', 10, 'coral_pink', 19),
(20, 'card', 0, 'player', 2367143, 'anchor', 14, 'octopus', 20),
...
(26, 'card', 0, 'player', 2367142, 'anchor', 1, 'octopus', 26),
(27, 'card', 0, 'player', 2367143, 'anchor', 1, 'bannerfish', 27),
(28, 'card', 0, 'player', 2367143, 'number', 15, 'coral_pink', 28),
...
(35, 'card', 0, 'center', 2, NULL, NULL, 'pufferfish', 35),
(36, 'card', 0, 'player', 2367142, 'number', 17, 'bannerfish', 36),
(37, 'card', 0, 'center', 3, NULL, NULL, 'octopus', 37),
(38, 'card', 0, 'player', 2367143, 'number', 17, 'coral_pink', 38),
(39, 'card', 0, 'player', 2367142, 'number', 18, 'bannerfish', 39);
